            ...
            <div class="tesinput">
                <form action="tambah.php" method="POST">
                    <div class="form-container">
                        ...
                        <input type="text" id="nama_lokasi" name="nama_lokasi" value="<?php if (isset($_POST['nama_lokasi'])) echo $_POST['nama_lokasi'] ?>" required>
                        <label for="">Alamat Lokasi</label>
                        <input type="text" name="alamat_lokasi" value="<?= isset($_POST['alamat_lokasi']) ? $_POST['alamat_lokasi'] : '' ?>" required>
